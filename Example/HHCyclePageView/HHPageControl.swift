...
class HHPageControl: UIControl {
    ...
    var pageIndicatorSpaing: CGFloat = 10 {
        didSet{
            if (indicatorViews.count > 0) {
                setNeedsLayout()
            }
    ...
    /// indicatorTint color
    var pageIndicatorTintColor: UIColor = UIColor(red: 128.0/255.0, green: 128.0/255.0, blue: 128.0/255.0, alpha: 1.0) {
        didSet{
            updateIndicatorViewsBehavior()
        }
    }
    ...
    /// indicator size
    var pageIndicatorSize: CGSize = CGSize(width: 6, height: 6) {
        didSet{
    ...
    var currentPageIndicatorSize: CGSize = CGSize(width: 6, height: 6) {
        didSet{
