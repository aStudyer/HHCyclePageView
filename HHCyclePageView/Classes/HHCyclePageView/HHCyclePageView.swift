...
@objc public protocol HHCyclePageViewDataSource: NSObjectProtocol {
...
@objc public protocol HHCyclePageViewDelegate: NSObjectProtocol {
    @objc optional
...
public class HHCyclePageView: UIView {
    ...
    public weak var dataSource: HHCyclePageViewDataSource?{
        didSet{
    ...
    public weak var delegate: HHCyclePageViewDelegate?{
        didSet{
    ...
    public var layout: HHCyclePageViewLayout? {
        set{
            _layout = newValue
        }
        get{
    ...
    public var autoScrollInterval: CGFloat = 0{
        didSet{
            removeTimer()
    ...
    public var reloadDataNeedResetIndex: Bool = false
    /// current page index
...
extension HHCyclePageView {
    ...
    public func registerClass(cls: AnyClass, withReuseIdentifier identifier: String) {
        collectionView.register(cls, forCellWithReuseIdentifier: identifier)
    }
    public func registerNib(nib: UINib, withReuseIdentifier identifier: String) {
        collectionView.register(nib, forCellWithReuseIdentifier: identifier)
    }
    public func dequeueReusableCell(withReuseIdentifier identifier: String, index: NSInteger) -> UICollectionViewCell {
