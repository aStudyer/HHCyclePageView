...
public enum HHCyclePageViewLayoutType {
    case normal
    case linear
    case coverflow
}
...
public class HHCyclePageViewLayout: NSObject {
    public var itemSize: CGSize = .zero
    public var itemSpacing: CGFloat = 0
    public var sectionInset: UIEdgeInsets = .zero
    public var layoutType: HHCyclePageViewLayoutType = .normal
    ...
    public var itemHorizontalCenter: Bool = true
